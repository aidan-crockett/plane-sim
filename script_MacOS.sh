...
em++ -o game.html src/main.cpp -Os -Wall ./raylibsrc/libraylib.a -I ./raylibsrc -L ./raylibsrc  -s USE_GLFW=3 -s ASYNCIFY -s TOTAL_MEMORY=134217728 -s STACK_SIZE=5MB --preload-file ./src/assets --shell-file ./raylibsrc/shell.html -DPLATFORM_WEB
